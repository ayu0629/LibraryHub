...
const ManageLibrary = () => {
  ...
  const deletelibrary = (id) => {
    axios
      .delete("http://localhost:5000/library/delete/" + id)
      .then((response) => {
      ...
      <table className="w-full rounded-xl">
        <thead>
          <tr className="bg-gray-200">
            <th className="">
              <div className="flex items-center py-5 px-5 "></div>
            </th>
            <th
              scope="col"
  ...
  return (
    <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-2">
      <div className="max-w-[90%] mx-auto m-5 ">
        <h1 className="text-3xl text-center font-bold p-10 bg-blue-800 text-white">
          Manage Library
        </h1>
        {displaylibrary()}
      </div>
