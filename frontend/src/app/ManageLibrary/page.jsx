...
const ManageLibrary = () => {
    ...
    const deletelibrary = (id) => {
        axios.delete('http://localhost:5000/library/delete/' + id)
            .then((response) => {
            ...
            <table className="w-full rounded-xl">
                <thead>
                    <tr className="bg-gray-200">
                        ...
                        <th
                            scope="col"
                            className="p-5 text-left whitespace-nowrap text-md leading-6 font-bold text-gray-900 capitalize"
                        >
                            {" "}
                            Language{" "}
                        </th>
                        ...
                        <th
                            scope="col"
                            className="p-5 text-left whitespace-nowrap text-md leading-6 font-bold text-gray-900 capitalize min-w-[150px]"
                        >
                            {" "}
                            Package Name{" "}
                        </th>
...

                    {
                        Librarylist.map(library => {
                            return (
                                ...
                                <tr key={library._id} className="bg-white transition-all duration-500 hover:bg-gray-50">
                                    <td className="">
                                        <div className="flex items-center py-5 px-5 ">
                                            <input
                                                type="checkbox"
                                    ...
                                    <td className="flex p-5 items-center gap-0.5">
                                        ...
                                        <button onClick={() => deletelibrary(library._id)}
    ...
    return (
        <div className='bg-gradient-to-r from-blue-100 to-blue-200 p-2'>


            <div className='max-w-[90%] mx-auto m-5 '>

                <h1 className='text-3xl text-center font-bold p-10 bg-blue-800 text-white'>Manage Library</h1>
                {displaylibrary()}
            </div>
        </div>
    )
