    ...
    <div>
      ...
      <div className="max-w-[85rem] px-4 py-10  sm:px-6 lg:px-8 lg:py-14 bg-black">
        ...
        <div className="chat chat-start flex justify-start mb-5">
          <div className="chat-bubble bg-indigo-500 text-slate-100 font-bold">
            Contact Us
          </div>
        </div>
        {/* END chat bubble */}
        ...
        <div className="grid grid-cols-1 md:grid md:grid-cols-2">
          <div>
            ...
            <h3 className="text-xl font-semibold md:mt-24 md:py-7 text-center text-white">
              Follow us
            </h3>
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
              ...
              >
                <div>
                  ...
                  <input
                    className="w-full rounded-lg border border-gray-700 p-3 text-black text-sm bg-white"
                    placeholder="Name"
                    type="text"
                    id="name"
                ...
                <div>
                  ...
                  <div>
                    ...
                    {contactForm.errors.phoneno &&
                    contactForm.touched.phoneno ? (
                      <div className="text-red-500 text-sm">
                        {contactForm.errors.phoneno}
                      </div>
                    ) : null}
                    <input
                      className="w-full rounded-lg bg-white text-black border border-gray-700 p-3 mt-4 text-sm"
                ...
                <div>
                  ...
                  <textarea
                    className="w-full rounded-lg bg-white border text-black border-gray-700 p-3 text-sm"
                    placeholder="Message"
                    rows="8"
                    id="message"
                    onChange={contactForm.handleChange}
